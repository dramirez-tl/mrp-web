...
export default function InventoryTable({
  ...
  const getLocationTypeBadge = (type: string) => {
    const typeConfig = {
      WAREHOUSE: { label: 'Almacén', className: 'bg-blue-100 text-blue-800' },
      PRODUCTION: { label: 'Producción', className: 'bg-purple-100 text-purple-800' },
      QUARANTINE: { label: 'Cuarentena', className: 'bg-yellow-100 text-yellow-800' },
      TRANSIT: { label: 'Tránsito', className: 'bg-gray-100 text-gray-800' },
    };
